	...
	<yonyou:modal id="editWin" modalClass="modal-lg modal-xl modal-xxl modal-xxxl modal-xxxxl" title="编辑人员信息" editable="true">
		<form id="editForm" class="form-horizontal form-bordered form-row-stripped" data-toggle="validator">
			...
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						<label class="control-label col-md-4" for="birthDate">出生日期</label>
						<div class="col-md-8">
							<yonyou:date id="birthDate" name="birthDate" placeholder="出生日期..." end="current" orientation="top" required="required" />
						</div>
					</div>
				</div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" id="idNumber" name="idNumber" placeholder="身份证号..." maxlength="18" required />
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-4" for="address">家庭住址</label>
                        <div class="col-md-8">
