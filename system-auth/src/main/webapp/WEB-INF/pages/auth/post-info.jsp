...
<html>
    <form id="postInfoForm" class="form-horizontal form-bordered form-row-stripped">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label col-md-4">所属部门：</label>
                    <div class="col-md-8">
                        <p class="form-control-static" data-property="department.name"></p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label col-md-4">部门长：</label>
                    <div class="col-md-8">
                        <p class="form-control-static" data-property="isLeader"></p>
                    </div>
                </div>
            </div>
        </div>
