package com.yoogun.core.infrastructure.mapper;
...
public class JaxbMapper {
	...
	public static String toXml(Object root, Class clazz, String encoding) {
		try {
			...
			throw new BusinessException("转换对象到XML失败！", e);
		}
	}
	...
	public static <T> T fromXml(String xml, Class<T> clazz) {
		try {
			...
			throw new BusinessException("转换XML到对象失败！", e);
		}
	}
	...
	public static Marshaller createMarshaller(Class clazz, String encoding) {
		try {
			...
			throw new BusinessException("创建Marshaller并设定encoding失败！", e);
		}
	}
	...
	public static Unmarshaller createUnmarshaller(Class clazz) {
		try {
			...
			throw new BusinessException("创建UnMarshaller失败！", e);
		}
	}
