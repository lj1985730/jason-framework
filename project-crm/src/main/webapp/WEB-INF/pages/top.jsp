<%@ page import="com.yoogun.auth.infrastructure.AuthCache" %>
...
<html>
	...
	<div id="pageHeader" class="page-header navbar navbar-fixed-top" >
		<div class="page-logo">
			<a href="javascript:">
				<img src="imgs/logo-light-yonyou.png" alt="logo" class="logo-default" />
			</a>
					...
					<li class="dropdown dropdown-user">
						<a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
							...
							<span id="topPersonName" class="username username-hide-on-mobile">
								你好：<shiro:principal />
								(<%=AuthCache.person() == null ? "" : AuthCache.person().getName()%>)
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<div class="col-md-10">
								<input id="oldPassword" name="oldPassword" type="text" class="form-control" maxlength="20" placeholder="原密码..." />
							</div>
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							...
							<div class="col-md-10">
								<input id="newPassword" name="newPassword" type="text" class="form-control" maxlength="20" placeholder="新密码..." />
							</div>
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							<label class="control-label col-md-2" for="againPassword">确认密码</label>
							<div class="col-md-10">
								<input id="againPassword" name="againPassword" type="text" class="form-control" maxlength="20" placeholder="确认新密码..." />
							</div>
						</div>
					</div>
				</div>
