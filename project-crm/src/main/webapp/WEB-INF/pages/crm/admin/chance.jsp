<%-- 作 者：Sheng Baoyu --%>
<%-- 本页说明：--%>
<%-- 本页地址:crm/admin/ChanceController/homeView --%>
<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"  %>
<%@ taglib prefix="yonyou" tagdir="/WEB-INF/tags" %>
<html>
	<yonyou:nav father="CRM" model="商机管理" />
	<div class="row">
		<div class="col-md-12">
			<div class="portlet box blue-dark">
				<div class="portlet-title">
					...
					<div class="actions">
						...
						<yonyou:delete id="deleteChance" permission="crm:chance:delete" />
					</div>
				</div>
				<div class="portlet-body">
					<div class="table-container">
						<table id="chanceTable" data-export="$.fn.export();">
							<thead>
