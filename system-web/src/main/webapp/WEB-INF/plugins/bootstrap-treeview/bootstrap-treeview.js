...
;(function ($, window, document, undefined) {
	...
	var Tree = function (element, options) {
		...
		return {
			...
			unselectAll: $.proxy(this.unselectAll, this),	//add unselectAll method by Liu Jun at 2018-4-9 11:09:56
			...
			findNode: $.proxy(this.findNode, this),	//增加findNode外部方法by liu jun at 2018-1-19 13:36:59
	...
	*/
	...
	/**
		...
		@param {String} field - Field to query pattern against
	...
	*/
	...
	/**
		...
		@param {Object} parentNode  - The node to which nodes will be added as children
		@param {number} index  - Zero based insert index
	...
	*/
    ...
    Tree.prototype.unselectAll = function (options) {
        ...
        var nodes = $.grep(this._orderedNodes, function (node) {
            return node.state.selected || node.state.selected === undefined;
        });

        this.unselectNode(nodes, options);
    };
